          ...
          >
            ...
            <div className="flex items-center justify-between mb-3 text-sm">
              <div>
                ...
                <span className="text-white font-medium">{formatPrice(entry.entryPrice)}</span>
              </div>
              <div>
                <span className="text-gray-400">Now </span>
                <span className="text-white font-medium">{formatPrice(entry.currentPrice)}</span>
              </div>
            </div>
